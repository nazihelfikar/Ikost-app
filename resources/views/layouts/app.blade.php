...
<head>
    ...
    <title>infoKostharmoni | @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/admin" class="brand-link">
                ...
                <span class="brand-text font-weight-light">info Kost Harmoni</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 <a href="#">infoKOSTHARMONI</a>.</strong> All rights reserved.
        </footer>
